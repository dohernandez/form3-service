...
// TransactionPaymentBeneficiaryUpdatedHandler۰v0 updates a payment's beneficiary handler for notifier messages
//
...
func TransactionPaymentBeneficiaryUpdatedHandler۰v0(updater PaymentBeneficiaryUpdater) goengine.MessageHandler {
	return func(ctx context.Context, state interface{}, message goengine.Message) (interface{}, error) {

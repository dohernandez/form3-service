Feature: Read payment
  ...
  Scenario: Payment should be deleted
    When I request REST endpoint with method "GET" and path "/v1/transaction/payments/71aa6f04-ede9-46f4-a63d-373c3c206fc1"
  ...
  Scenario: Payment should not be read, payment does not exists
    When I request REST endpoint with method "GET" and path "/v1/transaction/payments/f3f6f5fe-0e6c-40a2-8c50-265116b414d3"
